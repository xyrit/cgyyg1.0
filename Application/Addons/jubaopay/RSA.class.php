...
class RSA {
    ...
    public function __construct($conf) {
        ...
        print_r($this->_privFile);
       
//        echo "<br/><br/>";
//        print_r($this->_pubFile);
//        echo "<br/><br/>";
//        print_r($this->_algo);
//        echo "<br/><br/>";
//        print_r($this->_psw);
...
//        exit;
    ...
    public function sign($data) {//dump($data);
        $digest = $data . $this->_psw;
        $privKey = file_get_contents($this->_privFile);
        //$privKey = file_get_contents("shanghu.pfx");
        echo file_get_contents("shanghu.pfx");
//        dump($digest);
//        echo "<br/><br/>";
        dump($this->_privFile);
        echo "<br/><br/>";
        dump($privKey);
        echo "<br/><br/>";
        openssl_sign($digest, $signature, $this->_privFile, $this->_algo);
        dump($signature);
        exit;
