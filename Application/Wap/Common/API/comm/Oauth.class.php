...
//         $callback ='http://www.cgyyg.com/otherlogin/index.php/home/index/qqCallback';
        $callback ='http://df.cgyyg.com/index.php/home/index/qqCallback';
        ...
        if ($this->recorder->write('state',$state)) {
            echo 'recorder->write success';
        } else {
            echo 'recorder->write failure';
        }
...
//         $state = $this->recorder->read("state");
         if ($this->recorder->read('state')) {
             echo 'recorder->read success';
         } else {
             echo 'recorder->read failure';
         }
...
//             "redirect_uri" => urlencode('http://www.cgyyg.com/otherlogin/index.php/home/index/qqCallback'),
            "redirect_uri" => urlencode('http://df.cgyyg.com/index.php/home/index/qqCallback'),
